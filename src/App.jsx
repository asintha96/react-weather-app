...
function App() {
  ...
  useEffect(() => {
    if (locationButtonRef.current) {
      locationButtonRef.current.click(); // simulate click
    }
  }, []);
  ...
  return (
    ...
    <div className="bg-white shadow-lg mt-10 p-5 rounded w-full max-w-sm">
      <div className="flex">
        ...
        <button  ref ={locationButtonRef} onClick={getCurrenctLoacation}
    ...
    {error && <p className='text-red-500 text-center mt-4'>{error}</p>}
      ...
      {weatherData && (
        <div className="mt-4 text-center">
          ...
          <img src={weatherData.current.condition.icon} className="mx-auto h-40" alt='image1'/>
